...
{
    internal class CraftsmanshipFactory
    {
        ...
        private void LoadMappings()
        {
            ...
            XmlReader reader = XmlReader.Create(new StreamReader(Path.Combine("Resources", "Craftsmanship.xml")), settings);
            reader.Read();  // XML declaration
            reader.Read();  // Items element
            if (reader.LocalName != "Craftsmanship")
            {
                throw new System.InvalidOperationException("Bad craftsmanship file");
            }
            ...
            {
                reader.Read();
                if (reader.NodeType == XmlNodeType.EndElement && reader.LocalName == "Craftsmanship")
                    break;
