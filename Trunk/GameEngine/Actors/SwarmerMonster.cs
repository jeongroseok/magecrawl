...
namespace Magecrawl.GameEngine.Actors
{
    ...
    {
        public SwarmerMonster(string name, Point p, int maxHP, int vision, DiceRoll damage, double evade, double ctIncreaseModifer, double ctMoveCost, double ctActCost, double ctAttackCost)
