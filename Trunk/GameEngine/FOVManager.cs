...
namespace Magecrawl.GameEngine
{
    internal sealed class FOVManager : IDisposable
    {
        ...
        public void CalculateForMultipleCalls(Point viewPoint, int viewableDistance, Point pointWantToView)
        {
            m_fov.CalculateFOV(viewPoint.X, viewPoint.Y, viewableDistance, false, FovAlgorithm.Restrictive);
        }
